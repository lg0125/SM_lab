...
@WebServlet("/transMsgInfoServlet")
public class transMsgInfoServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("app/msgBoard/msgInfo.jsp").forward(request,response);
    }
}
