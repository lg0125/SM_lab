...
@WebServlet("/changeDeleteMsgReplyServlet")
public class changeDeleteMsgReplyServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ArrayList<Message> message_list = message_dao.query(teacher_id,replied);
        ArrayList<Message> temp = message_dao.query(teacher_id,notReplied);
        ...
        request.getRequestDispatcher("app/teacher/changeDeleteMsgReply.jsp").forward(request,response);
    }
}
