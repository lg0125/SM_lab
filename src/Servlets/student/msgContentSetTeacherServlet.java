...
@WebServlet("/msgContentSetTeacherServlet")
public class msgContentSetTeacherServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Integer number = message_list.size();

        PublicDAO public_dao = new PublicDAO();
        ArrayList<TeacherCourse> teacher_course_list = public_dao.query_TeacherCourseTeach();
