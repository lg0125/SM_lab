...
@WebServlet("/msgContentSetDeptServlet")
public class msgContentSetDeptServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ArrayList<TeacherCourse> teacher_course_list = public_dao.query_TeacherCourseDept();
