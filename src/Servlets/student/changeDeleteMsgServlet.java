...
@WebServlet("/changeDeleteMsgServlet")
public class changeDeleteMsgServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ArrayList<Message> message_list = message_dao.queryStudentId(student_id);
        ...
        request.getRequestDispatcher("app/student/changeDeleteMsg.jsp").forward(request,response);
    }
}
