...
<div class="container mb-3">
    <form method="post" action="${pageContext.request.contextPath}/changeCourseServlet">
        ...
        <div class="form-group">
            <label>course_new_id</label>
            <label>
                <input type="text" class="form-control" name="course_new_id" placeholder="Enter course_new_id" />
            </label>
        </div>
        ...
        <div class="form-group">
            ...
            <label>
                <input type="text" class="form-control" name="introduction" placeholder="Enter introduction" />
            </label>
        </div>
